...
function SignInForm() {
  ...
  // Validate env vars at render time — these are inlined at build time by Next.js
  ...
  async function go() {
    ...
    // Surface missing env vars immediately instead of hanging
    ...
    try {
      ...
      // Race signInWithOAuth against a 12-second timeout so a hung promise
      // surfaces as a visible error instead of silently freezing the button
