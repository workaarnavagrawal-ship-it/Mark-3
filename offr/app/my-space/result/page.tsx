...
export default function ResultPage() {
  ...
  if (!data) return (
    <div style={{ padding: "48px 52px" }}>
      ...
      <Link href="/my-space/assess" className="btn btn-prim">Run an assessment →</Link>
    </div>
  );
    ...
    <div style={{ padding: "48px 52px", maxWidth: "780px" }}>
      ...
      <div style={{ marginBottom: "32px" }}>
        <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", marginBottom: "20px" }}>
          ...
          <Link href="/my-space/assess" style={{ fontSize: "13px", color: "var(--t3)", textDecoration: "none" }}>New →</Link>
        </div>
      ...
      <div style={{ display: "flex", gap: "10px", marginTop: "8px" }}>
        <Link href="/my-space/assess" className="btn btn-prim">Try another →</Link>
        <Link href="/my-space/tracker" className="btn btn-ghost">View tracker</Link>
        <Link href="/my-space/ps" className="btn btn-ghost">Analyse PS</Link>
      </div>
    </div>
  );
}
